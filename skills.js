module.exports.skill1=function(data,strongArr,h1Arr,update_arr,myName)
{
    ...
    for(let i=0;i<block_array.length;i++)
    {
      ...
      {
        let skillreg=['technical skills','technology skills','key skills','relevant skills'];
      ...
      {
        let careerreg=['objective','career','summary','profile','introduction'];
...
function search(arrayArg,targetArr)
{
  ...
  execu.execu(data,addSkill,addSkillextra,addCareer,addLang,addProject,addExp,addEdu,addHobbie,myKeys);
  }
